...
declare module "modules/util/EventEmitter" {
    ...
    export default class EventEmitter extends NodeEventEmitter {
         ...
         */
        constructor();
        addEventListener: (eventName: string | symbol, listener: (...args: any[]) => void) => EventEmitter;
        removeEventListener: (eventName: string | symbol, listener: (...args: any[]) => void) => EventEmitter;
    }
    import { EventEmitter as NodeEventEmitter } from "events";
}
declare module "modules/RTCStats/RTCStats" {
    import JitsiConference from "JitsiConference";
    import { IRTCStatsConfiguration } from "modules/RTCStats/interfaces";
    ...
    class RTCStats {
         ...
         * @returns {void}
         */
        start(conference: JitsiConference): void;
        /**
...
declare module "modules/watchRTC/WatchRTC" {
    ...
    const _default_1: WatchRTCHandler;
...
declare module "modules/statistics/statistics" {
     ...
     * Statistics.
     */
    function Statistics(conference: any, options: StatisticsOptions): void;
    class Statistics {
        /**
         * The options to configure Statistics.
         * @typedef {Object} StatisticsOptions
...
declare module "JitsiTrackError" {
     ...
     */
    function JitsiTrackError(error: any | string, options: any, devices: any): void;
...
declare module "modules/util/Listenable" {
    ...
    export default class Listenable {
        eventEmitter: EventEmitter;
        addEventListener: (eventName: string, listener: Function) => EventEmitter;
         ...
         */
        addCancellableListener(eventName: string, listener: Function): Function;
        /**
         * Adds new listener.
         * @param {String} eventName the name of the event
         * @param {Function} listener the listener.
...
declare module "modules/e2ee/SAS" {
     ...
     * @returns {object}
     */
    export function generateSas(sasBytes: Uint8Array): object;
}
...
declare module "modules/xmpp/strophe.ping" {
    ...
    export default class PingConnectionPlugin extends PingConnectionPlugin_base {
        ...
        constructor({ getTimeSinceLastServerResponse, onPingThresholdExceeded, pingOptions }: {
            ...
            getTimeSinceLastServerResponse: Function;
            pingOptions: any;
        });
        failedPings: number;
...
declare module "modules/RTC/CodecSelection" {
    /**
    ...
    export class CodecSelection {
         ...
         * @returns {void}
         */
        _updateVisitorCodecs(codecList: any[]): void;
        /**
...
declare module "service/RTC/StandardVideoSettings" {
...
declare module "modules/RTC/TPCUtils" {
    ...
    export class TPCUtils {
         ...
         */
        _calculateActiveEncodingParams(localVideoTrack: any, codec: CodecMimeType, newHeight: number): any;
        /**
         ...
         */
        _configureSenderEncodings(localTrack: any): Promise<any>;
        /**
         ...
         * @param {String} codec
         */
        _getVideoStreamEncodings(localTrack: any, codec: string): {
            active: any;
            maxBitrate: any;
            rid: string;
            scaleResolutionDownBy: number;
        ...
        */
         ...
         */
        calculateEncodingsActiveState(localVideoTrack: any, codec: CodecMimeType, newHeight: number): Array<boolean>;
        /**
         ...
         */
        calculateEncodingsBitrates(localVideoTrack: any, codec: CodecMimeType, newHeight: number): Array<number>;
        /**
         ...
         */
        calculateEncodingsScalabilityMode(localVideoTrack: any, codec: CodecMimeType, maxHeight: number): Array<VideoEncoderScalabilityMode> | undefined;
        /**
         ...
         * @returns {Array<float>}
         */
        calculateEncodingsScaleFactor(localVideoTrack: any, codec: CodecMimeType, maxHeight: number): Array<any>;
        /**
...
declare module "modules/RTC/TraceablePeerConnection" {
    ...
    export default class TraceablePeerConnection {
         ...
         */
        configureAudioSenderEncodings(localAudioTrack?: any): Promise<any>;
        /**
         ...
         * @returns {Promise} promise that will be resolved when the operation is successful and rejected otherwise.
         */
        configureVideoSenderEncodings(localVideoTrack?: any): Promise<any>;
...
declare module "modules/statistics/AudioOutputProblemDetector" {
    /**
    ...
    export default class AudioOutputProblemDetector {
         ...
         * @returns {void}
         */
        _onRemoteAudioLevelReceived(userID: string, { avgAudioLevels }: {
            avgAudioLevels?: number;
        }): void;
        /**
...
declare module "JitsiMeetJS" {
    ...
    const _default_3: {
        ...
        */
         ...
         */
        createLocalTracksFromMediaStreams(tracksInfo: any): import("modules/RTC/JitsiLocalTrack").default[];
        /**
